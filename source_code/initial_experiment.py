...
""" May need to add a GET method here
"""
class CheckInQueue:
...
# Until we get to 360.0
# Advance by 0.01
# Check all three data sources:
# 1. Local Commuters in Coach
# 2. International Commuters in Coach
# 3. International Commuters in first class
#       for each --> if counter >= one of these --> add it to the right queue
#                    But first, put it into a tuple marked with its system time and class (commuter or first)

# Once a service location is free, someone can move to it... until then, they stay queued